      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] flex flex-col bg-sidebar/60 backdrop-blur-lg p-0 text-sidebar-foreground"
            style={
              {
